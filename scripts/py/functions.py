...
def deathsByStrength(curr):
    ...
    plt.title('Porcentaje de muertes en funcion de la potencia del fuego')
...
def deathsByPits(curr):
    ...
    for p in fires:
        ...
        avg.append(count / len(data) * 100 / population)
    fig, ax = plt.subplots()  # Create a figure containing a single axes.
    plt.title('Porcentaje de muertes en funcion de cant. de focos de fuego')
    plt.ylabel('Muertes en %')
...
def boxplot(curr):
    ...
    for experiment in experiments:
        ...
        ax.legend(['Promedio de muertes'], loc="upper left")
...
def compareExperiments(curr):
    ...
    ax.set_title('Comparación de % muertes en funcion de cant. de focos')
...
def compareExperimentsByStrength(curr):
    ...
    ax.set_title('Comparación de % muertes en funcion de intensidad del fuego')
